...
const blockByHash = await rpc("eth_getBlockByHash", [blockObject.hash, false]);
if (!blockByHash || typeof blockByHash !== "object" || blockByHash.hash !== blockObject.hash) throw new Error("BLOCK_BY_HASH_INVALID");
